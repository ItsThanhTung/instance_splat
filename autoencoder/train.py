...
if __name__ == '__main__':
    ...
    parser.add_argument('--segment_type', type=str, required=True)
    ...
    data_dir = f"{dataset_path}/{segment_type}/language_features"
    os.makedirs(f'ckpt/{args.dataset_name}_{segment_type}', exist_ok=True)
    ...
    logdir = f'ckpt/{args.dataset_name}_{segment_type}'
